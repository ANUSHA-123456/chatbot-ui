...
AS $$
DECLARE
  project_url TEXT := 'https://becpicujmfezugodytyd.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJlY3BpY3VqbWZlenVnb2R5dHlkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NTkxNjYwMSwiZXhwIjoyMDYxNDkyNjAxfQ.udc3anHL9PY8tPH1gGEQEeUJ75xP8d_k2woK1HOrLpU-service'
